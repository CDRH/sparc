class FeaturesController < ApplicationController
  ...
  active_scaffold :feature do |conf|
    ...
    conf.columns = [:units, :strata, :unit_no, :feature_no, :floor_association, :feature_form, :other_associated_features, :grid, :depth_m_b_d, :feature_occupation, :feature_type, :feature_count, :feature_group, :residentual_feature, :location_in_room, :t_shaped_door, :door_between_multiple_room, :doorway_sealed, :length, :width, :depth_height, :comments]
    ...
    conf.columns[:residentual_feature].form_ui = :select
