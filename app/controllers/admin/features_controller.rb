class Admin::FeaturesController < ApplicationController
  ...
  active_scaffold :feature do |conf|
    ...
    conf.columns = [:units, :strata, :unit_no, :feature_no, :floor_association, :feature_form, :other_associated_features, :grid, :depth_mbd, :occupation, :feature_type, :count, :feature_group, :residential_feature, :location_in_room, :t_shaped_door, :door_between_multiple_room, :doorway_sealed, :length, :width, :depth_height, :comments]
