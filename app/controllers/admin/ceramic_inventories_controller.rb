class Admin::CeramicInventoriesController < ApplicationController
  ...
  active_scaffold :ceramic_inventory do |conf|
    ...
    conf.update.columns = [:site, :fs, :box, :ceramic_inventory_count, :gridew, :gridns, :quad, :exactprov, :depthbeg, :depthend, :stratalpha, :strat_one, :strat_two, :othstrats, :field_date, :excavator, :art_type, :sano, :recordkey, :comments, :entby, :location]
