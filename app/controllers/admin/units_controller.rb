class Admin::UnitsController < ApplicationController
  ...
  active_scaffold :unit do |conf|
    conf.label = 'Units'
    conf.columns = [:unit_no, :zone, :excavation_status, :occupation, :unit_class, :story, :intact_roof, :room_type, :type_description, :inferred_function, :salmon_sector, :other_description, :irregular_shape, :length, :width, :floor_area, :comments, :strata]
    conf.update.columns = [:unit_no, :zone, :excavation_status, :occupation, :unit_class, :story, :intact_roof, :room_type, :type_description, :inferred_function, :salmon_sector, :other_description, :irregular_shape, :length, :width, :floor_area, :comments]
    ...
    conf.field_search.columns = [:unit_no, :zone, :excavation_status, :occupation, :unit_class, :story, :intact_roof, :room_type, :type_description, :inferred_function, :salmon_sector, :other_description, :irregular_shape, :length, :width, :floor_area, :comments, :strata]
  end
